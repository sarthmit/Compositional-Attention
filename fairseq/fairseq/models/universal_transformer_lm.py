...
from fairseq.models.universal_transformer import Embedding, TransformerDecoder
...
class TransformerLanguageModelConfig(FairseqDataclass):
    ...
    attention_type: str = field(
            default="Standard", metadata={"help": "Attention Mode"}
    )
    attention_rules: int = field(
            default=1, metadata={"help": "Number of rules to use"}
    )
    attn_dim: int = field(
            default=512, metadata={"help": "Attention Dimension"}
    )
    selection_dim: int = field(
            default=128, metadata={"help": "Attention Selection Dimension"}
    )
    q_compose: bool = field(
        default=False
    )
...
@register_model("universal_transformer_lm", dataclass=TransformerLanguageModelConfig)
class UniversalTransformerLanguageModel(FairseqLanguageModel):
    @classmethod
    def hub_models(cls):
    ...
    def build_model(cls, args, task):
        ...
        decoder = TransformerDecoder(
            args, task.target_dictionary, embed_tokens, no_encoder_attn=True, lm=True
        )
        return cls(decoder)
...
@register_model_architecture("universal_transformer_lm", "universal_transformer_lm_big")
...
@register_model_architecture("universal_transformer_lm", "universal_transformer_lm_wiki103")
@register_model_architecture("universal_transformer_lm", "universal_transformer_lm_baevski_wiki103")
...
@register_model_architecture("universal_transformer_lm", "universal_transformer_lm_gbw")
@register_model_architecture("universal_transformer_lm", "universal_transformer_lm_baevski_gbw")
...
@register_model_architecture("universal_transformer_lm", "universal_transformer_lm_gpt")
...
@register_model_architecture("universal_transformer_lm", "universal_transformer_lm_gpt2_small")
...
@register_model_architecture("universal_transformer_lm", "universal_transformer_lm_gpt2_medium")
...
@register_model_architecture("universal_transformer_lm", "universal_transformer_lm_gpt2_big")
