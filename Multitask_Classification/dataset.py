...
def make_square(img_size = (32, 32), num_points_per_cluster = 8, cluster_radius = 1):
	is_square = False
	while not is_square:
...
def make_rectangle(img_size = (32, 32), num_points_per_cluster = 8, cluster_radius = 1):
	is_rectangle = False
...
def make_right_angle_triangle(img_size = (32, 32), num_points_per_cluster = 8, cluster_radius = 1):
	is_rectangle = False
	while not is_rectangle:
		point_1_x = random.randint(0 + cluster_radius, img_size[0] - cluster_radius)
		point_1_y = random.randint(0 + cluster_radius, img_size[1] - cluster_radius)
...
def make_equilateral_triangle(img_size = (32, 32), make_equilateral = True, num_points_per_cluster = 8, cluster_radius = 1):
	if make_equilateral:
